...
_base_ = [
    '/opt/ml/detection/swin/configs/thr_down/cascade_mask_rcnn_swin_fpn_thr_down.py',
    '/opt/ml/detection/swin/configs/heavy_augs/coco_simillar_dataset_heavy_augs.py',
